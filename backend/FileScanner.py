...
def bi_contains(lst, item):
    # Reference: https://stackoverflow.com/questions/2701173/most-efficient-way-for-a-lookup-search-in-a-huge-list-python
...
class FileScanner:
    ...
    def __init__(self, path, signature_path):
        ...
        if os.path.isdir(path) and os.path.isfile(signature_path):
            ...
            print("SignaturePath: " + str(os.path.isdir(signature_path)) + " & " + str(os.path.exists(signature_path)))
    ...
    def get_hash_list(self):
        try:
            with open(self.signature_db_path) as fp:
                for line in fp:
